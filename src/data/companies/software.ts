...
export const software: Company[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    data_sources: ['Bentley Systems 10-K 2024', 'Industry analysis'],
  ...
  },
  {
    ...
    revenue_ttm_usd: 3.8,
    grid_revenue_pct: 40,
    description: 'Industrial software company (Schneider Electric subsidiary) with PI System historian platform serving ~95% of global utilities for operational data management.',
    headquarters: 'Cambridge, UK',
    primary_exchange: 'LSE',
    data_updated: '2024-12-01',
    data_sources: ['AVEVA Annual Report 2024', 'Industry analysis'],
    data_confidence: 'high'
  },
  {
    id: 'co_etap',
  ...
  },
  {
    ...
    data_updated: '2024-12-01',
    data_sources: ['Landis+Gyr Annual Report 2024', 'Industry reports'],
    data_confidence: 'high'
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    primary_exchange: 'NASDAQ',
    data_updated: '2024-12-01',
    data_sources: ['Fortinet 10-K 2024', 'Q3 2024 Earnings'],
    data_confidence: 'high'
  },
  {
    id: 'co_tenable',
    ...
    primary_exchange: 'NASDAQ',
    data_updated: '2024-12-01',
    data_sources: ['Tenable 10-K 2024', 'Industry analysis'],
    data_confidence: 'medium'
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    data_updated: '2024-12-01',
    data_sources: ['Fortive 10-K 2024', 'Q3 2024 Earnings'],
    data_confidence: 'medium'
  },
];
